...
fun dynamicSemanticColors(colorScheme: ColorScheme, isLight: Boolean): SemanticColors {
    ...
    // Warning has no counterpart in an M3 dynamic scheme, and borrowing an accent
    // tone here would read as success. Use Compound's orange, as the static SC themes do.
    val warningColor = if (isLight) LightColorTokens.colorOrange900 else DarkColorTokens.colorOrange900
    return SemanticColors(
        ...
        // Backgrounds – accent: pair with onAccent (M3 onPrimary), which is the dark tone in
        // dark mode. Using inversePrimary here instead would put a dark icon on a dark button.
        bgAccentRest = b.accent,
        bgAccentHovered = b.accent,
        bgAccentPressed = b.accent,
        bgAccentSelected = colorScheme.primaryContainer,
        bgAccentSubtle = b.accent.copy(alpha = 0.2f),
        ...
        // Backgrounds – success / info. SC treats success as the accent, not a
        // separate green, so the dynamic palette stays coherent.
        bgSuccessSubtle = colorScheme.tertiaryContainer,
        bgSuccessRest = b.accent,
        bgSuccessHovered = b.accent,
        bgSuccessPressed = b.accent,
        ...
        iconWarningPrimary = warningColor,
        ...
        textActionSuccess = b.accent,
        textWarningPrimary = warningColor,
...
fun dynamicScThemeExposures(colorScheme: ColorScheme, isLight: Boolean): ScThemeExposures {
    ...
    return ScThemeExposures(
        ...
        mentionBgLegacy = b.accent,
        mentionBgOtherLegacy = colorScheme.secondaryContainer,
        mentionFgOtherLegacy = colorScheme.onSecondaryContainer,
