        ...
        register("release") {
            ...
            storePassword = System.getenv("SC_RELEASE_STORE_PASSWORD")
                ...
                ?: if (releaseKeystoreFile.exists()) {
                    error("Release keystore present at ${releaseKeystoreFile.path} but no password (env SC_RELEASE_STORE_PASSWORD or signature/.release-keystore-password)")
                } else "android"
